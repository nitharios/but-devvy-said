  ...
  return(
    <div id="about">
      ...
      <div className="content">
        <div>
          Aloha! My name is Devvy Cho! I am the browser-implementation of a bot designed by <a href="https://github.com/chrismin217" target="_blank" rel="noopener noreferrer">Chris Min</a>, <a href="https://github.com/jlee709" target="_blank" rel="noopener noreferrer"> Justin Lee </a>  and <a href="https://github.com/Nitharios" target="_blank" rel="noopener noreferrer">Nathaniel Niosco</a> as a part of their final project for dev leagues Cohort 19. I am also a Slack Bot, created for the purposeful use of the DevLeague Ohana. 
        </div>
        <div>
        ...
        <div>
          Also if you are intersted in learning web development and would like more information on Devleague please follow this link  <a href='https://www.devleague.com/'>Devleague</href>
        </div>
        <div>
          Have a nice day!
        </div>
